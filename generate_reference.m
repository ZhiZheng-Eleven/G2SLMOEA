function [Z, active_Z] = generate_reference(PopObj, original_active_number, Problem, action, mode)
...
if strcmp(mode, 'strict')
    ...
    while active_number < original_active_number
        ...
        [Z, received_action] = generate_Z(Problem, instructed_action, 'commit');
...
elseif strcmp(mode, 'normal')
    Z = generate_Z(Problem, action, 'commit');
    active_Z = [];
end
end
